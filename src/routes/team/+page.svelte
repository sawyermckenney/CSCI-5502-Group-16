...
<div class="grid">
	<div class="card">
		...
		<p class="bio">Leading the design and implementation of data visualizations.</p>
	...
	<div class="card">
		...
		<p class="bio">Managing data collection, preprocessing, and quality assurance.</p>
	...
	<div class="card">
		...
		<p class="bio">Developing and tuning machine learning models for fraud detection.</p>
	...
	<div class="card">
		...
		<p class="bio">Designing evaluation frameworks and analyzing model performance.</p>
...
<style>
	...
	.card-glow {
		...
		width: 200%;
		height: 200%;
		background: radial-gradient(circle at center, rgba(236, 72, 153, 0.08), transparent 40%);
		opacity: 0;
