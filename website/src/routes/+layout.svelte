<script lang="ts">
	...
	const hideVideoBg = $derived(
		['/team', '/proposal', '/exploration', '/models', '/conclusion'].some((path) => page.url.pathname.startsWith(path))
	);
	...
	<nav>
		<div class="nav-inner">
			...
			<div class="nav-links">
				...
				<a href="/conclusion" class="nav-link" class:active={page.url.pathname.startsWith('/conclusion')}>Conclusion</a>
